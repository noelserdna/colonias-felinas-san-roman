La reproducción es lo que hace crecer una colonia. Verás cómo se reproducen los gatos, por qué conviene esterilizar pronto y qué hacer cuando aparece una camada.

> **Lo esencial**
>
> - Una gata puede quedar preñada desde los 4 meses y tener varias camadas al año.
> - La gestación dura unos 63-65 días (unas nueve semanas).
> - En la calle, unos tres de cada cuatro gatitos mueren antes de los 6 meses.
> - Entre las 2 y las 7 semanas de vida el gatito aprende a confiar (o no) en las personas.
> - Si encuentras una camada con su madre, no la toques ni la muevas: observa y avisa.

## Machos y hembras

Bajo la cola hay dos orificios: arriba el ano y debajo el genital. En la **hembra** están muy juntos y el genital es una pequeña hendidura vertical (el conjunto recuerda a una «i»). En el **macho** están más separados, porque entre ambos está el escroto, y el genital es redondo (recuerda a dos puntos, «:»).

Es más fácil distinguirlos en gatitos de pocas semanas, antes de que crezca el pelo; a partir de unas 10 semanas, en los machos se notan los testículos. Una pista: casi todos los gatos **carey o tricolor** son hembras.

<figure><img src="/img/curso/diagramas/sexado-gatitos.svg" alt="Dibujo de la zona bajo la cola de dos gatitos: en la hembra, ano y vulva muy juntos en forma de i; en el macho, ano y pene separados por el escroto en forma de dos puntos" loading="lazy" width="800" height="960"><figcaption>Hembra («i») y macho («:»): la clave es la distancia entre los dos orificios. <small>Esquema: elaboración propia · CC BY-SA 4.0</small></figcaption></figure>
...
Entre las **2 y las 7 semanas** de vida, el gatito está especialmente abierto a aprender qué es normal y qué es peligroso. Si en ese tiempo lo tocan con suavidad varias personas distintas, en sesiones cortas, lo más probable es que de adulto confíe en la gente. Si no tiene ese contacto, crecerá con miedo a las personas.

No todo depende de la experiencia: el carácter se hereda en parte de los padres, y el estrés de la madre durante la gestación también influye. Por eso algunos gatitos no se socializan aunque se intente.

Después de las 8 semanas cuesta mucho más. Un gato de **más de 4 meses** que no ha tenido contacto con personas no debe socializarse a la fuerza: lo que le conviene es el CER y volver a su colonia.

> **Importante:** forzar a un gatito que tiene mucho miedo (sujetarlo, encerrarlo en una habitación con gente) no lo amansa: lo aterroriza. Si tras varios días el miedo no cede, hay que parar y buscar otra salida.

## Qué hacer si encuentras una camada

<figure><img src="/img/curso/diagramas/camada-decision.svg" alt="Árbol de decisión: ¿está la madre? ¿qué edad tienen los gatitos? ¿son sociables? con las salidas dejar con la madre, atención urgente, adopción o CER" loading="lazy" width="800" height="1030"><figcaption>Qué hacer al encontrar una camada. <small>Esquema: elaboración propia · CC BY-SA 4.0</small></figcaption></figure>

> **Paso a paso: encontrar una camada**
>
> 1. **No la toques ni la muevas.** La madre suele estar cerca buscando comida; si la molestas, puede trasladar a los gatitos a un sitio peor.
...
|---|---|
| Menos de 1 semana | Ojos cerrados, orejas plegadas, apenas se mueve |
| 2 semanas | Ojos abiertos y azules, se arrastra |
| 3-4 semanas | Camina torpemente, orejas erguidas, empieza a jugar |
| 5-6 semanas | Corre, juega y come sólido |
| 7-8 semanas | Ágil e independiente; los ojos empiezan a perder el azul |
...
<figure><img src="/img/curso/reproduccion-y-gatitos/gata-con-gatitos.jpg" alt="Gata tricolor de pelo largo junto a dos gatitos, uno gris oscuro y otro naranja, que comen pienso de unos platos al aire libre" loading="lazy" width="1200" height="900"><figcaption>Madre con sus gatitos ya destetados: momento de valorar adopción y esterilización. <small>Foto: Jeff the Obscure · CC0 · Wikimedia Commons</small></figcaption></figure>

### Camadas en la ciudad

En la ciudad las gatas paren en **patios de manzana**, solares, **obras**, trasteros, **aparcamientos** o bajos de coches aparcados mucho tiempo: sitios que alguien puede cerrar o limpiar sin saberlo. Si la camada está en una obra, un garaje o una finca privada, avisa a tu programa para que hable con el responsable (la empresa, el administrador de fincas o la comunidad de vecinos) antes de que se tapien huecos.
...
- Halls, V., Ellis, S. y Bessant, C. (International Cat Care). «Cat Friendly Decision-Making: Outcomes for kittens born to free-roaming unowned cats». *Journal of Shelter Medicine and Community Animal Health*, 2023, 2: 57. Licencia CC BY 4.0; se han adaptado y traducido los apartados sobre socialización y miedo persistente. [Ver en línea](https://doi.org/10.56771/jsmcah.v2.57)
- Nutter, F., Levine, J. y Stoskopf, M. «Reproductive capacity of free-roaming domestic cats and kitten survival rate». *JAVMA*, 2004. [Ver en línea](https://doi.org/10.2460/javma.2004.225.1399)
- Johnson, A. K. «Normal feline reproduction: The queen». *Journal of Feline Medicine and Surgery*, 2022. [Ver en línea](https://pmc.ncbi.nlm.nih.gov/articles/PMC10845401/)
